...
def obter_cascata_de_modelos():
    ...
    try:
        ...
        melhor_lite = sorted(lite, reverse=True)[0] if lite else 'gemini-1.5-flash'
    ...
    except: return ['gemini-1.5-flash', 'gemini-1.5-flash', 'gemini-1.5-flash', 'gemini-1.5-flash', 'gemini-2.5-flash']
